...
const SelectDefaultImage = ({
	...
	const handleFileSelect: ChangeEventHandler<HTMLInputElement> = (event) => {
		...
		if (files) {
			...
			onImagesChange(images ? [...images, ...uploaded] : uploaded);
		}
	};
								...
								return (
									...
									>
										...
										<Collapse
											...
											classes={{
												wrapperInner:
													classes.imageActions,
											}}
										>
											<span
												className={classes.blurredBack}
											/>
											<Tooltip
